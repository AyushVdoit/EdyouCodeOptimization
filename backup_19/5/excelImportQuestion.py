...
def lambda_handler(event, context):
    if TokenChecker(event['token']):
        ...
        for d in data1: 
            count+=1
            required_fields = ["CorrectAnswer","description__001","description__002",
            # "description__003","description__004","description__005",
            "options__001","options__002",
            # "options__003","options__004","options__005",
            "Question"]
            ...
            OptionsGiven={'Question': 'A','options__001': 'B','description__001': 'C',
        ...
        if 'Item' in data2:
            ...
            for k in data:
                ...
                NewValue = {i:f"Option {chr(i+65)}" for i in range(length1)}
